...
<div class="col-md-2">
    ...
    <input maxlength="25" type="text" class="form-control" name="nombre" id="nombre" placeholder="Nombre" value=<?php echo $nombre->nombre;?>> 
  </div>
  <div class="col-md-5">
  ...
  <div class="col-8">
    ...
    <input maxlength="30" type="text" class="form-control" name="direccion" id="direccion" placeholder="Direccion" value=<?php echo $nombre->direccion;?>> 
  </div>
  <div class="col-4">
